...
* [Jellyfin-Enhanced](https://github.com/n00bcodr/Jellyfin-Enhanced) ⭐ 1,806 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-18 - Adds keyboard shortcuts, subtitle styling, TMDB reviews, Seerr search and request integration, and other improvements to Jellyfin. `✅ JF12`
...
* [jellyfin-plugin-home-sections](https://github.com/IAmParadox27/jellyfin-plugin-home-sections) ⭐ 513 | 🐛 45 | 🌐 C# | 📅 2026-09-15 - Allows users to customize the jellyfin-web home screen with dynamic sections like "Because You Watched" and "Latest Movies".
* [jellyfin-plugin-media-bar](https://github.com/IAmParadox27/jellyfin-plugin-media-bar) ⭐ 456 | 🐛 25 | 🌐 JavaScript | 📅 2026-09-15 - A Featured Content Bar to showcase your media collection.
...
* [SeerrFin](https://github.com/varunaditya-plus/SeerrFin) ⭐ 101 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-13 - Discover and request movies and TV shows through Seerr directly from Jellyfin.
...
* [jellyfin-plugin-mindthegaps](https://github.com/IDisposable/jellyfin-plugin-mindthegaps) ⭐ 29 | 🐛 2 | 🌐 C# | 📅 2026-09-18 - Finds missing entries across your library (collections, series episodes, cast and crew filmographies) and organizes them into a fillable report.
...
* [intro-skipper](https://github.com/intro-skipper/intro-skipper) ⭐ 2,777 | 🐛 14 | 🌐 C# | 📅 2026-09-18 - Fingerprint audio to automatically detect intro and outro segments in Jellyfin. `✅ JF12`
...
* [TheIntroDB](https://github.com/TheIntroDB/jellyfin-plugin) ⭐ 112 | 🐛 3 | 🌐 C# | 📅 2026-09-18 - Community powered database of intro, recap, credits, and preview segments for movies and TV shows.
...
* [Gelato](https://github.com/lostb1t/Gelato) ⭐ 804 | 🐛 35 | 🌐 C# | 📅 2026-09-16 - Replaces Jellyfin's default search with Stremio-powered results and can automatically import entire catalogs into your library through scheduled tasks.
...
* [Moonbase](https://github.com/Moonfin-Client/Plugin) ⭐ 388 | 🐛 10 | 🌐 C# | 📅 2026-09-18 - Companion plugin for Moonfin clients, providing server-side settings sync, integrations, and a hosted Moonfin Web interface.
* [Shokofin](https://github.com/ShokoAnime/Shokofin) ⭐ 313 | 🐛 2 | 🌐 C# | 📅 2026-09-18 - Integrates [Shoko Server](https://shokoanime.com/downloads/shoko-server) with Jellyfin for anime library management. `✅ JF12`
* [jellyfin-plugin-streamyfin](https://github.com/streamyfin/jellyfin-plugin-streamyfin) ⭐ 303 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-18 - Companion plugin for Streamyfin which allows for a centralized configuration of the Streamyfin application.
...
* [jellyfin-rpc by *kennethsible*](https://github.com/kennethsible/jellyfin-rpc) ⭐ 86 | 🐛 4 | 🌐 Python | 📅 2026-09-09 - Displays your current Jellyfin activity directly on Discord.
...
* [Jellyfin Security](https://github.com/ZL154/JellyfinSecurity) ⭐ 265 | 🐛 20 | 🌐 C# | 📅 2026-09-15 - Natively adds TOTP and email 2FA, passkeys, OIDC/SSO sign-in, brute-force protection, IP allowlists, device pairing, trusted browsers, and audit logging to Jellyfin.
...
* [Jellyfin Plugin Stash](https://github.com/DirtyRacer1337/Jellyfin.Plugin.Stash) ⭐ 78 | 🐛 8 | 🌐 C# | 📅 2026-09-10 - Metadata provider for [Stash](https://github.com/stashapp/stash) ⭐ 12,982 | 🐛 735 | 🌐 Go | 📅 2026-09-10.
...
* [jellyfin-plugin-justwatch](https://github.com/IDisposable/jellyfin-plugin-justwatch) ⭐ 6 | 🐛 2 | 🌐 C# | 📅 2026-09-18 - Adds JustWatch external IDs and streaming-provider deep-links to movies, series, seasons, and episodes. `✅ JF12`
...
* [Posterizarr](https://github.com/fscorrupt/posterizarr) ⭐ 926 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-18 - Automates poster, background, and title card creation for Plex, Jellyfin, and Emby with customizable overlays.
...
* [seerr](https://github.com/seerr-team/seerr) ⭐ 12,624 | 🐛 371 | 🌐 TypeScript | 📅 2026-09-18 - Request management and media discovery tool for Jellyfin, Plex, and Emby.
...
* [SuggestArr](https://github.com/giuseppe99barchetta/SuggestArr) ⭐ 1,316 | 🐛 9 | 🌐 Python | 📅 2026-09-16 - Automatically request suggested movies and TV shows to [Seerr](https://github.com/seerr-team/seerr) ⭐ 12,624 | 🐛 371 | 🌐 TypeScript | 📅 2026-09-18 based on recently watched.
...
* [List-Sync](https://github.com/Woahai321/list-sync) ⭐ 335 | 🐛 22 | 🌐 Python | 📅 2025-12-30 - Automatically import movies and TV shows from IMDB or Trakt lists into [Seerr](https://github.com/seerr-team/seerr) ⭐ 12,624 | 🐛 371 | 🌐 TypeScript | 📅 2026-09-18. `🔹 Beta`
* [Anchorr](https://github.com/openVESSL/Anchorr) ⭐ 136 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-11 - Discord bot for Jellyfin media requests and new content notifications.
...
* [watchstate](https://github.com/arabcoders/watchstate) ⭐ 1,554 | 🐛 1 | 🌐 PHP | 📅 2026-09-18 - Syncs play state between different media servers.
...
* [wizarr](https://github.com/wizarrrr/wizarr) ⭐ 3,193 | 🐛 144 | 🌐 Python | 📅 2026-09-18 - Advanced user invitation and management system.
...
* [jellyfin-telegram-channel-sync](https://github.com/GeiserX/jellyfin-telegram-channel-sync) ⚠️ Archived - Syncs Jellyfin user access with Telegram channel membership, automatically disabling accounts when members leave.
...
* [AudioMuse-AI](https://github.com/NeptuneHub/AudioMuse-AI) ⭐ 2,607 | 🐛 23 | 🌐 Python | 📅 2026-09-17 - Uses sonic analysis and AI-powered clustering to create tempo and mood-based playlists via the Jellyfin API.
...
* [ytdl-sub](https://github.com/jmbannon/ytdl-sub) ⭐ 2,944 | 🐛 125 | 🌐 Python | 📅 2026-09-14 - Automates downloading and metadata generation with yt-dlp.
...
* [trailarr](https://github.com/nandyalu/trailarr) ⭐ 463 | 🐛 6 | 🌐 Python | 📅 2026-09-17 - Manages trailer downloads for your Radarr and Sonarr libraries.
...
* [Tracearr](https://github.com/connorgallopo/Tracearr) ⭐ 2,615 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-18 - Real-time Jellyfin monitoring dashboard for tracking streams and detecting account sharing.
* [Samsung-Jellyfin-Installer](https://github.com/Jellyfin2Samsung/Samsung-Jellyfin-Installer) ⭐ 2,030 | 🐛 1 | 🌐 C# | 📅 2026-09-17 - Cross-platform tool that helps you install Jellyfin on Samsung Smart TVs running Tizen OS.
...
* [Universal Plugin Repo](https://github.com/0belous/universal-plugin-repo) ⭐ 258 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-17 - Consolidates many plugin repositories to create a universal catalogue.
...
* [tunarr](https://github.com/chrisbenincasa/tunarr) ⭐ 2,578 | 🐛 198 | 🌐 TypeScript | 📅 2026-09-18 - Create custom live TV channels from your Plex or Jellyfin library with a web UI and IPTV support.
...
* [jelly-clipper](https://github.com/arnolicious/jelly-clipper) ⭐ 91 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-18 - Web application for creating, sharing, and managing video clips from Jellyfin libraries. `🔹 Beta`
* [Jellyfin Episodes Ratings Grid](https://github.com/Damocles-fr/jellyfin-imdb-episodes-heatmap-ratings-grid) ⭐ 36 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-18 - Show IMDb episode ratings in a heatmap-style grid on Jellyfin series pages.
...
* [Dispatcharr](https://github.com/Dispatcharr/Dispatcharr) ⭐ 4,037 | 🐛 271 | 🌐 JavaScript | 📅 2026-09-15 - Self-hosted M3U proxy with IPTV, EPG, and VOD management support.
* [ErsatzTV](https://github.com/ErsatzTV/ErsatzTV) ⭐ 2,951 | 🐛 0 | 🌐 C# | 📅 2026-09-18 - Stream custom live channels using your own media. `🔹 Beta`
* [Explo](https://github.com/LumePart/Explo) ⭐ 1,975 | 🐛 47 | 🌐 Go | 📅 2026-09-09 - Automated music discovery tool that recommends tracks based on your listening history.
* [Threadfin](https://github.com/Threadfin/Threadfin) ⭐ 1,715 | 🐛 6 | 🌐 Go | 📅 2025-10-03 - M3U proxy for Jellyfin (Based on xTeVe).
* [Multi Scrobbler](https://github.com/FoxxMD/multi-scrobbler) ⭐ 1,228 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-18 - Scrobbles music from many sources to many clients. `🔹 Beta`
...
* [Movary](https://github.com/leepeuker/movary) ⭐ 778 | 🐛 94 | 🌐 PHP | 📅 2026-09-08 - Media tracker and user rating platform. `🔹 Beta`
* [locatarr](https://github.com/Locatarr/locatarr.github.io) ⭐ 482 | 🐛 1 | 📅 2026-07-24 - A list of tools used to automate the downloading and organization of media files.
  * [sonarr](https://github.com/Sonarr/Sonarr) ⭐ 16,344 | 🐛 87 | 🌐 C# | 📅 2026-09-16 - Automates downloading & management of TV series.
  * [radarr](https://github.com/Radarr/Radarr) ⭐ 14,386 | 🐛 530 | 🌐 C# | 📅 2026-09-16 - Automates downloading & management of movies.
  * [tdarr](https://github.com/HaveAGitGat/Tdarr) ⭐ 4,328 | 🐛 46 | 🌐 Makefile | 📅 2026-09-18 - Distributed transcode automation + Library analytics + Video health checking. `🔺 Paid`
  * [recyclarr](https://github.com/recyclarr/recyclarr) ⭐ 2,106 | 🐛 19 | 🌐 C# | 📅 2026-09-18 - Automatically sync TRaSH guides to Sonarr and Radarr instances.
...
You can also [create a new issue](https://github.com/awesome-jellyfin/awesome-jellyfin/issues/new) ⭐ 9,319 | 🐛 52 | 🌐 Shell | 📅 2026-09-12.
