...
* [Jellyfin-Enhanced](https://github.com/n00bcodr/Jellyfin-Enhanced) ⭐ 1,827 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-22 - Adds keyboard shortcuts, subtitle styling, TMDB reviews, Seerr search and request integration, and other improvements to Jellyfin. `✅ JF12`
...
* [jellyfin-plugin-home-sections](https://github.com/IAmParadox27/jellyfin-plugin-home-sections) ⭐ 515 | 🐛 49 | 🌐 C# | 📅 2026-09-15 - Allows users to customize the jellyfin-web home screen with dynamic sections like "Because You Watched" and "Latest Movies".
* [jellyfin-plugin-media-bar](https://github.com/IAmParadox27/jellyfin-plugin-media-bar) ⭐ 459 | 🐛 27 | 🌐 JavaScript | 📅 2026-09-15 - A Featured Content Bar to showcase your media collection.
...
* [SeerrFin](https://github.com/varunaditya-plus/SeerrFin) ⭐ 109 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-13 - Discover and request movies and TV shows through Seerr directly from Jellyfin.
...
* [Custom Cover Art](https://github.com/Bardesss/customcoverart) ⭐ 7 | 🐛 0 | 🌐 C# | 📅 2026-09-22 - A Jellyfin plugin for designing and applying custom cover art to your media libraries. `✅ JF12`
...
* [jellyfin-plugin-mindthegaps](https://github.com/IDisposable/jellyfin-plugin-mindthegaps) ⭐ 32 | 🐛 1 | 🌐 C# | 📅 2026-09-22 - Finds missing entries across your library (collections, series episodes, cast and crew filmographies) and organizes them into a fillable report.
...
* [intro-skipper](https://github.com/intro-skipper/intro-skipper) ⭐ 2,792 | 🐛 14 | 🌐 C# | 📅 2026-09-22 - Fingerprint audio to automatically detect intro and outro segments in Jellyfin. `✅ JF12`
...
* [Gelato](https://github.com/lostb1t/Gelato) ⭐ 814 | 🐛 19 | 🌐 C# | 📅 2026-09-22 - Replaces Jellyfin's default search with Stremio-powered results and can automatically import entire catalogs into your library through scheduled tasks.
...
* [jellyfin-ani-sync](https://github.com/vosmiic/jellyfin-ani-sync) ⭐ 491 | 🐛 24 | 🌐 C# | 📅 2026-09-22 - Automatically tracks and synchronizes anime watching progress between Jellyfin and [Anilist](https://anilist.co/) and other services.
* [Moonbase](https://github.com/Moonfin-Client/Plugin) ⭐ 394 | 🐛 11 | 🌐 C# | 📅 2026-09-22 - Companion plugin for Moonfin clients, providing server-side settings sync, integrations, and a hosted Moonfin Web interface.
* [Shokofin](https://github.com/ShokoAnime/Shokofin) ⭐ 316 | 🐛 3 | 🌐 C# | 📅 2026-09-20 - Integrates [Shoko Server](https://shokoanime.com/downloads/shoko-server) with Jellyfin for anime library management. `✅ JF12`
...
* [jellyfin-plugin-listenbrainz](https://github.com/lyarenei/jellyfin-plugin-listenbrainz) ⭐ 219 | 🐛 16 | 🌐 C# | 📅 2026-09-22 - Automatically syncs your music activity with ListenBrainz.
...
* [MyAnimeSync](https://github.com/iankiller77/MyAnimeSync) ⭐ 68 | 🐛 3 | 🌐 C# | 📅 2026-09-22 - Automatically synchronizes anime watching progress between Jellyfin and MyAnimeList.
...
* [Jellyfin.Plugin.JF\_To\_Stash\_Sync](https://github.com/Druidblack/Jellyfin.Plugin.JF_To_Stash_Sync) ⭐ 8 | 🐛 0 | 🌐 C# | 📅 2026-09-22 - Synchronizes viewing activity with Stash.
...
* [Jellyfin Security](https://github.com/ZL154/JellyfinSecurity) ⭐ 266 | 🐛 24 | 🌐 C# | 📅 2026-09-22 - Natively adds TOTP and email 2FA, passkeys, OIDC/SSO sign-in, brute-force protection, IP allowlists, device pairing, trusted browsers, and audit logging to Jellyfin.
...
* [whisper-subs](https://github.com/GeiserX/whisper-subs) ⭐ 102 | 🐛 3 | 🌐 C# | 📅 2026-09-22 - Automatically generates subtitles using local AI models powered by Whisper, with all processing on your server.
...
* [Jellyfin-Xtream-Library](https://github.com/firestaerter3/Jellyfin-Xtream-Library) ⭐ 89 | 🐛 8 | 🌐 C# | 📅 2026-09-16 - Syncs Xtream VOD and Series content to native Jellyfin libraries via STRM files, with automatic metadata lookup and Live TV support.
...
* [jellyfin-plugin-kinopoisk](https://github.com/LinFor/jellyfin-plugin-kinopoisk) ⭐ 173 | 🐛 14 | 🌐 C# | 📅 2026-07-22 - Metadata provider for [Kinopoisk](https://www.kinopoisk.ru/).
...
* [Jellyfin Plugin Stash](https://github.com/DirtyRacer1337/Jellyfin.Plugin.Stash) ⭐ 78 | 🐛 8 | 🌐 C# | 📅 2026-09-10 - Metadata provider for [Stash](https://github.com/stashapp/stash) ⭐ 13,004 | 🐛 741 | 🌐 Go | 📅 2026-09-22.
...
* [seerr](https://github.com/seerr-team/seerr) ⭐ 12,660 | 🐛 373 | 🌐 TypeScript | 📅 2026-09-22 - Request management and media discovery tool for Jellyfin, Plex, and Emby.
* [reiverr](https://github.com/aleksilassila/reiverr) ⭐ 2,345 | 🐛 67 | 🌐 TypeScript | 📅 2026-02-19 - Combined interface for Jellyfin, TMDB, Radarr, and Sonarr. `🔹 Beta`
* [SuggestArr](https://github.com/giuseppe99barchetta/SuggestArr) ⭐ 1,319 | 🐛 15 | 🌐 Python | 📅 2026-09-21 - Automatically request suggested movies and TV shows to [Seerr](https://github.com/seerr-team/seerr) ⭐ 12,660 | 🐛 373 | 🌐 TypeScript | 📅 2026-09-22 based on recently watched.
...
* [AudioBookRequest](https://github.com/markbeep/AudioBookRequest) ⭐ 704 | 🐛 52 | 🌐 Python | 📅 2026-08-21 - Request management tool for audiobooks on Plex, Jellyfin, and Audiobookshelf.
* [List-Sync](https://github.com/Woahai321/list-sync) ⭐ 336 | 🐛 22 | 🌐 Python | 📅 2025-12-30 - Automatically import movies and TV shows from IMDB or Trakt lists into [Seerr](https://github.com/seerr-team/seerr) ⭐ 12,660 | 🐛 373 | 🌐 TypeScript | 📅 2026-09-22. `🔹 Beta`
* [Anchorr](https://github.com/openVESSL/Anchorr) ⭐ 136 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-22 - Discord bot for Jellyfin media requests and new content notifications.
...
* [Jellystat](https://github.com/CyferShepard/Jellystat) ⭐ 2,474 | 🐛 185 | 🌐 JavaScript | 📅 2026-09-08 - Statistics and analytics dashboard for Jellyfin.
* [watchstate](https://github.com/arabcoders/watchstate) ⭐ 1,561 | 🐛 1 | 🌐 PHP | 📅 2026-09-21 - Syncs play state between different media servers.
...
* [jellyfin-rewind](https://github.com/Chaphasilor/jellyfin-rewind) ⭐ 377 | 🐛 12 | 🌐 JavaScript | 📅 2026-01-17 - A *Spotify Wrapped*-like experience for Jellyfin music listeners.
...
* [wizarr](https://github.com/wizarrrr/wizarr) ⭐ 3,199 | 🐛 146 | 🌐 Python | 📅 2026-09-22 - Advanced user invitation and management system.
...
* [jellysweep](https://github.com/jon4hz/jellysweep) ⭐ 255 | 🐛 39 | 🌐 Go | 📅 2026-09-21 - Automatically removes old, unwatched movies and TV shows by analyzing viewing history and user requests.
...
* [AudioMuse-AI](https://github.com/NeptuneHub/AudioMuse-AI) ⭐ 2,627 | 🐛 21 | 🌐 Python | 📅 2026-09-22 - Uses sonic analysis and AI-powered clustering to create tempo and mood-based playlists via the Jellyfin API.
...
* [ytdl-sub](https://github.com/jmbannon/ytdl-sub) ⭐ 2,951 | 🐛 125 | 🌐 Python | 📅 2026-09-21 - Automates downloading and metadata generation with yt-dlp.
...
* [trailarr](https://github.com/nandyalu/trailarr) ⭐ 467 | 🐛 10 | 🌐 Python | 📅 2026-09-22 - Manages trailer downloads for your Radarr and Sonarr libraries.
...
* [Tracearr](https://github.com/connorgallopo/Tracearr) ⭐ 2,653 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-22 - Real-time Jellyfin monitoring dashboard for tracking streams and detecting account sharing.
* [Samsung-Jellyfin-Installer](https://github.com/Jellyfin2Samsung/Samsung-Jellyfin-Installer) ⭐ 2,052 | 🐛 1 | 🌐 C# | 📅 2026-09-22 - Cross-platform tool that helps you install Jellyfin on Samsung Smart TVs running Tizen OS.
* [Jellyswarrm](https://github.com/LLukas22/Jellyswarrm) ⭐ 908 | 🐛 33 | 🌐 Rust | 📅 2026-09-20 - Reverse proxy that lets you combine multiple Jellyfin servers into one virtual instance.
...
* [jellyfin-helper](https://github.com/JellyPlugins/jellyfin-helper) ⭐ 58 | 🐛 1 | 🌐 C# | 📅 2026-09-22 - Server administration dashboard with cleanup tasks, library statistics, health checks, Arr/Seerr integration, backups, user insights, and on-device neural recommendations.
...
* [tunarr](https://github.com/chrisbenincasa/tunarr) ⭐ 2,588 | 🐛 191 | 🌐 TypeScript | 📅 2026-09-22 - Create custom live TV channels from your Plex or Jellyfin library with a web UI and IPTV support.
* [embyToLocalPlayer](https://github.com/kjtsune/embyToLocalPlayer) ⭐ 1,437 | 🐛 1 | 🌐 Python | 📅 2026-09-10 - Lets you watch videos from Jellyfin using a local video player (like VLC and MPV) and syncs watch progress back.
...
* [KefinTweaks](https://github.com/ranaldsgift/KefinTweaks) ⭐ 668 | 🐛 52 | 🌐 JavaScript | 📅 2026-09-22 - Collection of UI enhancements and customization tweaks for Jellyfin.
...
* [jelly-clipper](https://github.com/arnolicious/jelly-clipper) ⭐ 92 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-22 - Web application for creating, sharing, and managing video clips from Jellyfin libraries. `🔹 Beta`
...
* [Dispatcharr](https://github.com/Dispatcharr/Dispatcharr) ⭐ 4,102 | 🐛 279 | 🌐 JavaScript | 📅 2026-09-22 - Self-hosted M3U proxy with IPTV, EPG, and VOD management support.
* [ErsatzTV](https://github.com/ErsatzTV/ErsatzTV) ⭐ 2,959 | 🐛 0 | 🌐 C# | 📅 2026-09-22 - Stream custom live channels using your own media. `🔹 Beta`
...
* [Multi Scrobbler](https://github.com/FoxxMD/multi-scrobbler) ⭐ 1,235 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-22 - Scrobbles music from many sources to many clients. `🔹 Beta`
...
* [locatarr](https://github.com/Locatarr/locatarr.github.io) ⭐ 482 | 🐛 1 | 📅 2026-07-24 - A list of tools used to automate the downloading and organization of media files.
  * [sonarr](https://github.com/Sonarr/Sonarr) ⭐ 16,455 | 🐛 94 | 🌐 C# | 📅 2026-09-21 - Automates downloading & management of TV series.
  * [radarr](https://github.com/Radarr/Radarr) ⭐ 14,415 | 🐛 531 | 🌐 C# | 📅 2026-09-20 - Automates downloading & management of movies.
  * [tdarr](https://github.com/HaveAGitGat/Tdarr) ⭐ 4,329 | 🐛 45 | 🌐 Makefile | 📅 2026-09-19 - Distributed transcode automation + Library analytics + Video health checking. `🔺 Paid`
  * [recyclarr](https://github.com/recyclarr/recyclarr) ⭐ 2,117 | 🐛 23 | 🌐 C# | 📅 2026-09-22 - Automatically sync TRaSH guides to Sonarr and Radarr instances.
...
You can also [create a new issue](https://github.com/awesome-jellyfin/awesome-jellyfin/issues/new) ⭐ 9,369 | 🐛 56 | 🌐 Shell | 📅 2026-09-12.
