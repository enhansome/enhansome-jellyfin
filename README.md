...
* [Jellyfin-Enhanced](https://github.com/n00bcodr/Jellyfin-Enhanced) ⭐ 1,835 | 🐛 33 | 🌐 JavaScript | 📅 2026-09-23 - Adds keyboard shortcuts, subtitle styling, TMDB reviews, Seerr search and request integration, and other improvements to Jellyfin. `✅ JF12`
...
* [jellyfin-plugin-media-bar](https://github.com/IAmParadox27/jellyfin-plugin-media-bar) ⭐ 458 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-15 - A Featured Content Bar to showcase your media collection.
...
* [SeerrFin](https://github.com/varunaditya-plus/SeerrFin) ⭐ 111 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-13 - Discover and request movies and TV shows through Seerr directly from Jellyfin.
* [HoverTrailer](https://github.com/Fovty/HoverTrailer) ⭐ 96 | 🐛 0 | 🌐 C# | 📅 2026-09-11 - Displays movie trailers on hover.
* [Achievement Badges](https://github.com/ZL154/AchievementBadges_for_Jellyfin) ⭐ 66 | 🐛 15 | 🌐 HTML | 📅 2026-09-21 - Unlockable viewing achievement badges that gamify Jellyfin with milestones like first watch, binge sessions, and late-night viewing with social features such as group chats and messaging.
...
* [jellyfin-smartlists-plugin](https://github.com/jyourstone/jellyfin-smartlists-plugin) ⭐ 367 | 🐛 3 | 🌐 C# | 📅 2026-09-22 - Creates dynamic collections and playlists in Jellyfin that automatically update based on customizable rules as the library changes.
* [jellyfin-plugin-auto-collections](https://github.com/KeksBombe/jellyfin-plugin-auto-collections) ⭐ 292 | 🐛 18 | 🌐 C# | 📅 2026-09-08 - Automatically creates and maintains dynamic collections based on flexible criteria.
...
* [jellyfin-plugin-mindthegaps](https://github.com/IDisposable/jellyfin-plugin-mindthegaps) ⭐ 32 | 🐛 1 | 🌐 C# | 📅 2026-09-23 - Finds missing entries across your library (collections, series episodes, cast and crew filmographies) and organizes them into a fillable report.
...
* [intro-skipper](https://github.com/intro-skipper/intro-skipper) ⭐ 2,792 | 🐛 14 | 🌐 C# | 📅 2026-09-23 - Fingerprint audio to automatically detect intro and outro segments in Jellyfin. `✅ JF12`
* [jellyfin-plugin-cinemamode](https://github.com/CherryFloors/jellyfin-plugin-cinemamode) ⭐ 162 | 🐛 29 | 🌐 HTML | 📅 2026-08-08 - Enables Jellyfin's Cinema Mode with local trailers and pre-rolls.
* [TheIntroDB](https://github.com/TheIntroDB/jellyfin-plugin) ⭐ 116 | 🐛 3 | 🌐 C# | 📅 2026-09-18 - Community powered database of intro, recap, credits, and preview segments for movies and TV shows.
...
* [jellyfin-ani-sync](https://github.com/vosmiic/jellyfin-ani-sync) ⭐ 492 | 🐛 24 | 🌐 C# | 📅 2026-09-22 - Automatically tracks and synchronizes anime watching progress between Jellyfin and [Anilist](https://anilist.co/) and other services.
* [Moonbase](https://github.com/Moonfin-Client/Plugin) ⭐ 395 | 🐛 11 | 🌐 C# | 📅 2026-09-23 - Companion plugin for Moonfin clients, providing server-side settings sync, integrations, and a hosted Moonfin Web interface.
* [Shokofin](https://github.com/ShokoAnime/Shokofin) ⭐ 316 | 🐛 4 | 🌐 C# | 📅 2026-09-20 - Integrates [Shoko Server](https://shokoanime.com/downloads/shoko-server) with Jellyfin for anime library management. `✅ JF12`
...
* [jellyfin-plugin-listenbrainz](https://github.com/lyarenei/jellyfin-plugin-listenbrainz) ⭐ 219 | 🐛 16 | 🌐 C# | 📅 2026-09-23 - Automatically syncs your music activity with ListenBrainz.
...
* [Jellyfin Security](https://github.com/ZL154/JellyfinSecurity) ⭐ 269 | 🐛 16 | 🌐 C# | 📅 2026-09-23 - Natively adds TOTP and email 2FA, passkeys, OIDC/SSO sign-in, brute-force protection, IP allowlists, device pairing, trusted browsers, and audit logging to Jellyfin.
...
* [jellyfin-plugin-meilisearch](https://github.com/arnesacnussem/jellyfin-plugin-meilisearch) ⭐ 333 | 🐛 11 | 🌐 C# | 📅 2026-07-21 - Enhances Jellyfin search speed and accuracy by offloading queries to a Meilisearch instance. `✅ JF12`
...
* [whisper-subs](https://github.com/GeiserX/whisper-subs) ⭐ 102 | 🐛 3 | 🌐 C# | 📅 2026-09-23 - Automatically generates subtitles using local AI models powered by Whisper, with all processing on your server.
...
* [Jellyfin-Xtream-Library](https://github.com/firestaerter3/Jellyfin-Xtream-Library) ⭐ 89 | 🐛 6 | 🌐 C# | 📅 2026-09-23 - Syncs Xtream VOD and Series content to native Jellyfin libraries via STRM files, with automatic metadata lookup and Live TV support.
...
* [Jellyfin Plugin Stash](https://github.com/DirtyRacer1337/Jellyfin.Plugin.Stash) ⭐ 78 | 🐛 8 | 🌐 C# | 📅 2026-09-10 - Metadata provider for [Stash](https://github.com/stashapp/stash) ⭐ 13,005 | 🐛 741 | 🌐 Go | 📅 2026-09-22.
...
* [TitleCardMaker](https://github.com/CollinHeist/TitleCardMaker) ⭐ 857 | 🐛 24 | 🌐 Python | 📅 2026-08-31 - Automated title card maker for Plex, Jellyfin, and Emby.
...
* [seerr](https://github.com/seerr-team/seerr) ⭐ 12,670 | 🐛 369 | 🌐 TypeScript | 📅 2026-09-23 - Request management and media discovery tool for Jellyfin, Plex, and Emby.
...
* [SuggestArr](https://github.com/giuseppe99barchetta/SuggestArr) ⭐ 1,320 | 🐛 16 | 🌐 Python | 📅 2026-09-21 - Automatically request suggested movies and TV shows to [Seerr](https://github.com/seerr-team/seerr) ⭐ 12,670 | 🐛 369 | 🌐 TypeScript | 📅 2026-09-23 based on recently watched.
...
* [List-Sync](https://github.com/Woahai321/list-sync) ⭐ 336 | 🐛 22 | 🌐 Python | 📅 2025-12-30 - Automatically import movies and TV shows from IMDB or Trakt lists into [Seerr](https://github.com/seerr-team/seerr) ⭐ 12,670 | 🐛 369 | 🌐 TypeScript | 📅 2026-09-23. `🔹 Beta`
...
* [Jellystat](https://github.com/CyferShepard/Jellystat) ⭐ 2,475 | 🐛 186 | 🌐 JavaScript | 📅 2026-09-08 - Statistics and analytics dashboard for Jellyfin.
...
* [streamystats](https://github.com/fredrikburmester/streamystats) ⭐ 814 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-14 - Statistics service for Jellyfin, providing analytics and data visualization.
...
* [wizarr](https://github.com/wizarrrr/wizarr) ⭐ 3,203 | 🐛 147 | 🌐 Python | 📅 2026-09-23 - Advanced user invitation and management system.
...
* [subgen](https://github.com/McCloudS/subgen) ⭐ 1,486 | 🐛 5 | 🌐 Python | 📅 2026-08-07 - Autogenerate subtitles using OpenAI Whisper Model via Jellyfin.
...
* [AudioMuse-AI](https://github.com/NeptuneHub/AudioMuse-AI) ⭐ 2,635 | 🐛 21 | 🌐 Python | 📅 2026-09-23 - Uses sonic analysis and AI-powered clustering to create tempo and mood-based playlists via the Jellyfin API.
...
* [ytdl-sub](https://github.com/jmbannon/ytdl-sub) ⭐ 2,952 | 🐛 125 | 🌐 Python | 📅 2026-09-21 - Automates downloading and metadata generation with yt-dlp.
...
* [trailarr](https://github.com/nandyalu/trailarr) ⭐ 469 | 🐛 10 | 🌐 Python | 📅 2026-09-23 - Manages trailer downloads for your Radarr and Sonarr libraries.
...
* [Tracearr](https://github.com/connorgallopo/Tracearr) ⭐ 2,660 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-23 - Real-time Jellyfin monitoring dashboard for tracking streams and detecting account sharing.
* [Samsung-Jellyfin-Installer](https://github.com/Jellyfin2Samsung/Samsung-Jellyfin-Installer) ⭐ 2,059 | 🐛 2 | 🌐 C# | 📅 2026-09-23 - Cross-platform tool that helps you install Jellyfin on Samsung Smart TVs running Tizen OS.
...
* [jellyfin-helper](https://github.com/JellyPlugins/jellyfin-helper) ⭐ 59 | 🐛 1 | 🌐 C# | 📅 2026-09-23 - Server administration dashboard with cleanup tasks, library statistics, health checks, Arr/Seerr integration, backups, user insights, and on-device neural recommendations.
...
* [tunarr](https://github.com/chrisbenincasa/tunarr) ⭐ 2,591 | 🐛 196 | 🌐 TypeScript | 📅 2026-09-23 - Create custom live TV channels from your Plex or Jellyfin library with a web UI and IPTV support.
...
* [KefinTweaks](https://github.com/ranaldsgift/KefinTweaks) ⭐ 672 | 🐛 53 | 🌐 JavaScript | 📅 2026-09-23 - Collection of UI enhancements and customization tweaks for Jellyfin.
...
* [jelly-clipper](https://github.com/arnolicious/jelly-clipper) ⭐ 93 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-22 - Web application for creating, sharing, and managing video clips from Jellyfin libraries. `🔹 Beta`
...
* [Jellyfin Segment Editor](https://github.com/intro-skipper/segment-editor) ⭐ 15 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-23 - Manage Jellyfin Media Segment positions.
...
* [Dispatcharr](https://github.com/Dispatcharr/Dispatcharr) ⭐ 4,114 | 🐛 282 | 🌐 JavaScript | 📅 2026-09-23 - Self-hosted M3U proxy with IPTV, EPG, and VOD management support.
* [ErsatzTV](https://github.com/ErsatzTV/ErsatzTV) ⭐ 2,965 | 🐛 0 | 🌐 C# | 📅 2026-09-23 - Stream custom live channels using your own media. `🔹 Beta`
* [Explo](https://github.com/LumePart/Explo) ⭐ 1,989 | 🐛 46 | 🌐 Go | 📅 2026-09-09 - Automated music discovery tool that recommends tracks based on your listening history.
* [Threadfin](https://github.com/Threadfin/Threadfin) ⭐ 1,720 | 🐛 6 | 🌐 Go | 📅 2025-10-03 - M3U proxy for Jellyfin (Based on xTeVe).
* [Multi Scrobbler](https://github.com/FoxxMD/multi-scrobbler) ⭐ 1,237 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-23 - Scrobbles music from many sources to many clients. `🔹 Beta`
...
* [Movary](https://github.com/leepeuker/movary) ⭐ 779 | 🐛 96 | 🌐 PHP | 📅 2026-09-23 - Media tracker and user rating platform. `🔹 Beta`
* [locatarr](https://github.com/Locatarr/locatarr.github.io) ⭐ 482 | 🐛 1 | 📅 2026-07-24 - A list of tools used to automate the downloading and organization of media files.
  * [sonarr](https://github.com/Sonarr/Sonarr) ⭐ 16,494 | 🐛 95 | 🌐 C# | 📅 2026-09-23 - Automates downloading & management of TV series.
  * [radarr](https://github.com/Radarr/Radarr) ⭐ 14,423 | 🐛 531 | 🌐 C# | 📅 2026-09-20 - Automates downloading & management of movies.
  * [tdarr](https://github.com/HaveAGitGat/Tdarr) ⭐ 4,330 | 🐛 45 | 🌐 Makefile | 📅 2026-09-23 - Distributed transcode automation + Library analytics + Video health checking. `🔺 Paid`
  * [recyclarr](https://github.com/recyclarr/recyclarr) ⭐ 2,118 | 🐛 23 | 🌐 C# | 📅 2026-09-22 - Automatically sync TRaSH guides to Sonarr and Radarr instances.
...
You can also [create a new issue](https://github.com/awesome-jellyfin/awesome-jellyfin/issues/new) ⭐ 9,377 | 🐛 56 | 🌐 Shell | 📅 2026-09-12.
